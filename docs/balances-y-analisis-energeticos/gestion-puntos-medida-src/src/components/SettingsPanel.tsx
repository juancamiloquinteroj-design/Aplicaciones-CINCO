...
export default function SettingsPanel({
  ...
  return (
    <div className="space-y-6">
      ...
      <div id="section_firebase_status" className="bg-slate-50 dark:bg-zinc-900/50 backdrop-blur-md p-6 rounded-xl border border-slate-200 dark:border-zinc-800 shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
          ...
          <button
            ...
            disabled={checkingFb}
            className="inline-flex items-center gap-1.5 bg-slate-100 dark:bg-zinc-800 hover:bg-slate-200 dark:hover:bg-zinc-700 disabled:bg-slate-50 dark:disabled:bg-zinc-900 disabled:text-slate-600 dark:disabled:text-zinc-600 border border-slate-300 dark:border-zinc-700 text-slate-700 dark:text-zinc-300 font-bold text-xs px-3 py-1.5 rounded-lg transition-colors cursor-pointer"
          >
        ...
        {fbStatus.connected ? (
          <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-lg text-emerald-600 dark:text-emerald-400">
          ...
          <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-lg text-amber-600 dark:text-amber-400">
            <div className="flex items-center gap-2 font-bold text-sm mb-1.5">
